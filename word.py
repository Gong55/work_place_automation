...
excel_file = r'data_input.xlsx'
template_file = r'SIC Draft Contract.docx'
destination_folder = r'output'
owner_contract = r'owner_contract.docx'
...
print(df_flipped['owner_passport_expire_date_year'])
print(df_flipped['owner_passport_expire_date_2_year'])
